...
<html>
    <head>
        ...
        <link href="<?=$sysconf['admin_template']['css'].'?'.date('this')?>" rel="stylesheet" type="text/css" />
        <!-- Only SLiMS Bulian -->
        ...
        <header class="w-full block fixed bg-white z-10">
            <div class="flex flex-row">
                ...
                <div class="text-gray-700 text-center w-3/12">
                    <img class="py-2 mr-4 ml-2 float-right rounded-full h-10 w-10" src="<?=SWB?>images/persons/<?=$_SESSION['upict']?>" />
                    <!-- Ask Question -->
